...
public class SummarizeRoomReservationWithAdminTokenApiTest extends BaseApiTest {
    ...
    @Test
    public void summarizeRoomReservationWithAdminTokenShouldReturnOk() {
    ...
    @Test
    public void summarizeRoomReservationForNonExistentRoomIdWithAdminTokenShouldReturnNotFound() {
    ...
    @Test
    public void summarizeRoomReservationForInvalidRoomIdWithAdminTokenShouldReturnBadRequest() {
        RoomReservationRequestSave roomReservation = roomReservationCreator.createRoomReservation();
